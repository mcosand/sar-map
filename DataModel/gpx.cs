...
using System.Xml.Serialization;
  ...
  {
    private static XmlSerializer serializer = new XmlSerializer(typeof(gpxType));
    ...
    public gpxType()
    {
      ...
      this.trk = new List<trkType>();
      this.wpt = new List<wptType>();
      this.rte = new List<rteType>();
    }
    ...
    public override string ToString()
    {
      ...
      {
        using (var xmlWriter = XmlWriter.Create(stream, new XmlWriterSettings { Encoding = new System.Text.UTF8Encoding(false, false), Indent = true }))
        {
          gpxType.serializer.Serialize(xmlWriter, this);
          return System.Text.Encoding.UTF8.GetString(stream.ToArray());
        }
      }
    }

    public static gpxType FromString(string xml)
    {
      ...
      {
        return (gpxType)(gpxType.serializer.Deserialize(reader));
      }
    }
  ...
  public partial class trkType
  {
    ...
    public trkType()
    {
      this.trkseg = new List<trksegType>();
      this.link = new List<linkType>();
    }
  }
